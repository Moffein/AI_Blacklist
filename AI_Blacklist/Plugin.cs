...
namespace AI_Blacklist
{
    ...
    public class AI_Blacklist : BaseUnityPlugin
    {
        public void ReadConfig()
        {
            ...
            VengeanceBlacklist.vengeanceItemBlacklistString = base.Config.Bind<string>(new ConfigDefinition("Vengeance Settings", "Vengeance Item Blacklist"), "ShieldBooster, ShockNearby, NovaOnHeal, Thorns", new ConfigDescription("Item Blacklist for Vengeance Clones. Same format as the global AI item blacklist.")).Value;
